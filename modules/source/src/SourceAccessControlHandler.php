...
/**
 * Access controller for the Source entity.
 *
 * @see \Drupal\source\Entity\Source.
 */
class SourceAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\source\Entity\SourceInterface $entity */
    ...
    switch ($operation) {
      ...
      case 'view':
        ...
        if (!$entity->isPublished()) {
          ...
          return AccessResult::allowedIfHasPermission($account, 'view unpublished source entities');
        }
        ...
        return AccessResult::allowedIfHasPermission($account, 'view published source entities');
      ...
      case 'update':
        ...
        return AccessResult::allowedIfHasPermission($account, 'edit source entities');
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete source entities');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add source entities');
  }
